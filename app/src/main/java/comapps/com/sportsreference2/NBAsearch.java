...
public class NBAsearch extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String jsonBasketballLinks = null;
        try {
            jsonBasketballLinks = converJsonToStringFromAssetFolder(getApplicationContext());
        ...
        try {
            array = new JSONArray(jsonBasketballLinks);
        ...
        listen_for_enter.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View view, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN)
                    ...
                    String searchToPass = "http://m.pfref.com/search.fcgi?search=" + searchfinal;
    ...
    private static String converJsonToStringFromAssetFolder(Context context) throws IOException {
        ...
        InputStream file = manager.open("basketball_links.json");
