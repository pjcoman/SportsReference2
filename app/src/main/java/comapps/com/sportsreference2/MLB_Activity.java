 ...
 */
public class MLB_Activity extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView = (AutoCompleteTextView) findViewById(R.id.searchtextbaseball);
        ...
        lcTextView.setText(prefs.getInt("BASEBALL_LINKS_COUNT", 0) + " links");
        ...
        if (bar != null) {
            bar.setTitle("Baseball Reference");
        }
        ...
        if (prefs.getBoolean("FIRSTRUNMLB", true)) {
            ...
            databaseReferenceItems = FirebaseDatabase.getInstance().getReference().child("baseball");
            databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot child : dataSnapshot.getChildren()) {
                        ...
                        Map<String, String> newChild = (Map<String, String>) child.getValue();

                        names.add(newChild.get("name"));
                        links.add(newChild.get("link"));

                     //   lcTextView.setText(i + " of " + dataSnapshot.getChildrenCount() + "links updated");

                    }


                    time = System.currentTimeMillis();
                    editor.putLong("BASEBALL_LASTUPDATE", time);
                    editor.commit();


                    Gson gson = new Gson();
                    String jsonNames = gson.toJson(names);
                    editor.putString("BASEBALL_ITEMS_NAMES_GSON", jsonNames);
                    //        Log.d(TAG, "names " + jsonNames);
                    String jsonLinks = gson.toJson(links);
                    editor.putString("BASEBALL_ITEMS_LINKS_GSON", jsonLinks);
            //        Log.d(TAG, "links " + jsonLinks);
                    ...
                    editor.putInt("BASEBALL_LINKS_COUNT", names.size());
                    editor.commit();
            ...
            editor.putBoolean("FIRSTRUNMLB", false);
            editor.commit();

        } else {

            Gson gson = new Gson();
            names = gson.fromJson(prefs.getString("BASEBALL_ITEMS_NAMES_GSON", ""), ArrayList.class);
            links = gson.fromJson(prefs.getString("BASEBALL_ITEMS_LINKS_GSON", ""), ArrayList.class);
        ...
        databaseReferenceData.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    firebaseUpdate = newUpdateChild.get("baseball");


                }


                userUpdate = prefs.getLong("BASEBALL_LASTUPDATE", 0);
                ...
                if (firebaseUpdate > userUpdate) {
                    ...
                    databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast toast = Toast.makeText(getBaseContext(), "baseball links updated", Toast.LENGTH_LONG);
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                for (int w = 0; w < names.size(); w++) {
                    ...
                    if (names.get(w).equals(selection)) {
                        ...
                        Log.d("Name to pass ", nameSelected);
...
// TODO Auto-generated method stub
                EditText et = (EditText) findViewById(R.id.searchtextbaseball);
                assert et != null;
                et.setText("");
                return false;
            }
        ...
        EditText listen_for_enter = (EditText) findViewById(R.id.searchtextbaseball);
        ...
        listen_for_enter.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View view, int keyCode, KeyEvent event) {
                ...
                if ((event.getAction() == KeyEvent.ACTION_DOWN)
                    ...
                    EditText gettext = (EditText) findViewById(R.id.searchtextbaseball);
                    assert gettext != null;
                    String search = gettext.getText().toString();
                    String searchfinal = search.replaceAll(" ", "+");

                    String searchToPass = "http://www.baseball-reference.com/search/search.fcgi?hint=" + searchfinal + "&search=" + searchfinal + "&pid=";

                    // http://www.pro-baseball-reference.com/search/search.fcgi?hint=tom+Ackerman&search=tom&pid=
