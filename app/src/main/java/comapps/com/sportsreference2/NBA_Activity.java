 ...
 */
public class NBA_Activity extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView = (AutoCompleteTextView) findViewById(R.id.searchtextbasketball);
        ...
        lcTextView.setText(prefs.getInt("BASKETBALL_LINKS_COUNT", 0) + " links");
        ...
        if (bar != null) {
            bar.setTitle("Basketball Reference");
        }
        ...
        if (prefs.getBoolean("FIRSTRUNNBA", true)) {
            ...
            databaseReferenceItems = FirebaseDatabase.getInstance().getReference().child("basketball");
            databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    editor.putLong("BASKETBALL_LASTUPDATE", time);
                    editor.commit();


                    Gson gson = new Gson();
                    String jsonNames = gson.toJson(names);
                    editor.putString("BASKETBALL_ITEMS_NAMES_GSON", jsonNames);
                //    Log.d(TAG, "names " + jsonNames);
                    String jsonLinks = gson.toJson(links);
                    editor.putString("BASKETBALL_ITEMS_LINKS_GSON", jsonLinks);
                //    Log.d(TAG, "links " + jsonLinks);
                    ...
                    editor.putInt("BASKETBALL_LINKS_COUNT", names.size());
                    editor.commit();
            ...
            editor.putBoolean("FIRSTRUNNBA", false);
            editor.commit();

        } else {

            Gson gson = new Gson();
            names = gson.fromJson(prefs.getString("BASKETBALL_ITEMS_NAMES_GSON", ""), ArrayList.class);
            links = gson.fromJson(prefs.getString("BASKETBALL_ITEMS_LINKS_GSON", ""), ArrayList.class);
        ...
        databaseReferenceData.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    firebaseUpdate = newUpdateChild.get("basketball");


                }


                userUpdate = prefs.getLong("BASKETBALL_LASTUPDATE", 0);
                ...
                if (firebaseUpdate > userUpdate) {
                    ...
                    databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast toast = Toast.makeText(getBaseContext(), "basketball links updated", Toast.LENGTH_LONG);
...
// TODO Auto-generated method stub
                EditText et = (EditText) findViewById(R.id.searchtextbasketball);
                assert et != null;
                et.setText("");
                return false;
            }
        ...
        EditText listen_for_enter = (EditText) findViewById(R.id.searchtextbasketball);
        ...
        listen_for_enter.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View view, int keyCode, KeyEvent event) {
                ...
                if ((event.getAction() == KeyEvent.ACTION_DOWN)
                    ...
                    EditText gettext = (EditText) findViewById(R.id.searchtextbasketball);
                    assert gettext != null;
                    String search = gettext.getText().toString();
                    String searchfinal = search.replaceAll(" ", "+");

                    String searchToPass = "http://www.basketball-reference.com/search/search.fcgi?hint=" + searchfinal + "&search=" + searchfinal + "&pid=";

                    // http://www.pro-basketball-reference.com/search/search.fcgi?hint=tom+Ackerman&search=tom&pid=
