 ...
 */
public class NHL_Activity extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {

    private static final String TAG = "NHL";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView = (AutoCompleteTextView) findViewById(R.id.searchtexthockey);
        ...
        lcTextView.setText(prefs.getInt("HOCKEY_LINKS_COUNT", 0) + " links");
        ...
        if (prefs.getBoolean("FIRSTRUNNHL", true)) {

            progressBar2.setVisibility(View.VISIBLE);

            inProgress = true;

            databaseReferenceItems = FirebaseDatabase.getInstance().getReference().child("hockey");
            databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    editor.putLong("HOCKEY_LASTUPDATE", time);
                    editor.commit();


                    Gson gson = new Gson();
                    String jsonNames = gson.toJson(names);
                    editor.putString("HOCKEY_ITEMS_NAMES_GSON", jsonNames);
                //    Log.d(TAG, "names " + jsonNames);
                    String jsonLinks = gson.toJson(links);
                    editor.putString("HOCKEY_ITEMS_LINKS_GSON", jsonLinks);
                //    Log.d(TAG, "links " + jsonLinks);
                    ...
                    editor.putInt("HOCKEY_LINKS_COUNT", names.size());
                    editor.commit();
            ...
            editor.putBoolean("FIRSTRUNNHL", false);
            editor.commit();

        } else {

            Gson gson = new Gson();
            names = gson.fromJson(prefs.getString("HOCKEY_ITEMS_NAMES_GSON", ""), ArrayList.class);
            links = gson.fromJson(prefs.getString("HOCKEY_ITEMS_LINKS_GSON", ""), ArrayList.class);
        ...
        databaseReferenceData.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    firebaseUpdate = newUpdateChild.get("hockey");


                }


                userUpdate = prefs.getLong("HOCKEY_LASTUPDATE", 0);
                ...
                if (firebaseUpdate > userUpdate) {
                    ...
                    databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast toast = Toast.makeText(getBaseContext(), "hockey links updated", Toast.LENGTH_LONG);
        ...
        listen_for_enter.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View view, int keyCode, KeyEvent event) {
                ...
                if ((event.getAction() == KeyEvent.ACTION_DOWN)
                    ...
                    String searchToPass = "http://www.hockey-reference.com/search/search.fcgi?hint=" + searchfinal + "&search=" + searchfinal + "&pid=";

                    // http://www.pro-hockey-reference.com/search/search.fcgi?hint=tom+Ackerman&search=tom&pid=
