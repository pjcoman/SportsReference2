 ...
 */
public class CBB_Activity extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cbblayout);

        autoCompleteTextView = (AutoCompleteTextView) findViewById(R.id.searchtextcollegebasketball);
        ...
        lcTextView.setText(prefs.getInt("COLLEGEBASKETBALL_LINKS_COUNT", 0) + " links");
        ...
        if (bar != null) {
            bar.setTitle("College Basketball Reference");
        }
        ...
        if (prefs.getBoolean("FIRSTRUNCBB", true)) {
            ...
            databaseReferenceItems = FirebaseDatabase.getInstance().getReference().child("college_basketball");
            databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    editor.putLong("COLLEGEBASKETBALL_LASTUPDATE", time);
                    editor.commit();


                    Gson gson = new Gson();
                    String jsonNames = gson.toJson(names);
                    editor.putString("COLLEGEBASKETBALL_ITEMS_NAMES_GSON", jsonNames);
            //        Log.d(TAG, "names " + jsonNames);
                    String jsonLinks = gson.toJson(links);
                    editor.putString("COLLEGEBASKETBALL_ITEMS_LINKS_GSON", jsonLinks);
             //       Log.d(TAG, "links " + jsonLinks);
                    ...
                    editor.putInt("COLLEGEBASKETBALL_LINKS_COUNT", names.size());
                    editor.commit();
            ...
            editor.putBoolean("FIRSTRUNCBB", false);
            editor.commit();

        } else {

            Gson gson = new Gson();
            names = gson.fromJson(prefs.getString("COLLEGEBASKETBALL_ITEMS_NAMES_GSON", ""), ArrayList.class);
            links = gson.fromJson(prefs.getString("COLLEGEBASKETBALL_ITEMS_LINKS_GSON", ""), ArrayList.class);
        ...
        databaseReferenceData.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    firebaseUpdate = newUpdateChild.get("college_basketball");


                }


                userUpdate = prefs.getLong("COLLEGEBASKETBALL_LASTUPDATE", 0);
                ...
                if (firebaseUpdate > userUpdate) {
                    ...
                    databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast toast = Toast.makeText(getBaseContext(), "college basketball links updated", Toast.LENGTH_LONG);
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                for (int w = 0; w < names.size(); w++) {
                    ...
                    if (names.get(w).equals(selection)) {
                        ...
                        intent.putExtra("whichactivity", "collegebasketball");
...
// TODO Auto-generated method stub
                EditText et = (EditText) findViewById(R.id.searchtextcollegebasketball);
                assert et != null;
                et.setText("");
                return false;
            }
        ...
        EditText listen_for_enter = (EditText) findViewById(R.id.searchtextcollegebasketball);
        ...
        listen_for_enter.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View view, int keyCode, KeyEvent event) {
                ...
                if ((event.getAction() == KeyEvent.ACTION_DOWN)
                    ...
                    EditText gettext = (EditText) findViewById(R.id.searchtextcollegebasketball);
                    assert gettext != null;
                    String search = gettext.getText().toString();
                    String searchfinal = search.replaceAll(" ", "+");

                    String searchToPass = "http://www.sports-reference.com/cbb/search/search.fcgi?hint=" + searchfinal + "&search=" + searchfinal + "&pid=";
