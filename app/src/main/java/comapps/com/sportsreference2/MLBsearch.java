 ...
 */
public class MLBsearch extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
  ...
  //  private GestureDetector detector;
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   detector = new GestureDetector(this);
        ...
        String jsonBaseballLinks = null;
        try {
            jsonBaseballLinks = converJsonToStringFromAssetFolder(getApplicationContext());
        ...
        try {
            array = new JSONArray(jsonBaseballLinks);
    ...
    //    String[] names = res.getStringArray(R.array.mlb_suggestions);
        ...
        textView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
             ...
             //   String[] names = res.getStringArray(R.array.mlb_suggestions);
             //   String[] websites = res
             //           .getStringArray(R.array.mlb_suggestions_websites);
        ...
        listen_for_enter.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View view, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN)
                    ...
                    String searchToPass = "http://m.bbref.com/search.fcgi?search=" + searchfinal;
    ...
    private static String converJsonToStringFromAssetFolder(Context context) throws IOException {
        ...
        InputStream file = manager.open("baseball_links.json");
