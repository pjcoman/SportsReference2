 ...
 */
public class CFB_Activity extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {

    private static final String TAG = "CFB";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView = (AutoCompleteTextView) findViewById(R.id.searchtextcollegefootball);
        ...
        lcTextView.setText(prefs.getInt("COLLEGEFOOTBALL_LINKS_COUNT", 0) + " links");
        ...
        if (prefs.getBoolean("FIRSTRUNCFB", true)) {
            ...
            databaseReferenceItems = FirebaseDatabase.getInstance().getReference().child("college_football");
            databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    editor.putLong("COLLEGEFOOTBALL_LASTUPDATE", time);
                    editor.commit();


                    Gson gson = new Gson();
                    String jsonNames = gson.toJson(names);
                    editor.putString("COLLEGEFOOTBALL_ITEMS_NAMES_GSON", jsonNames);
               //     Log.d(TAG, "names " + jsonNames);
                    String jsonLinks = gson.toJson(links);
                    editor.putString("COLLEGEFOOTBALL_ITEMS_LINKS_GSON", jsonLinks);
               //     Log.d(TAG, "links " + jsonLinks);
                    ...
                    editor.putInt("COLLEGEFOOTBALL_LINKS_COUNT", names.size());
                    editor.commit();
            ...
            editor.putBoolean("FIRSTRUNCFB", false);
            editor.commit();

        } else {

            Gson gson = new Gson();
            names = gson.fromJson(prefs.getString("COLLEGEFOOTBALL_ITEMS_NAMES_GSON", ""), ArrayList.class);
            links = gson.fromJson(prefs.getString("COLLEGEFOOTBALL_ITEMS_LINKS_GSON", ""), ArrayList.class);
        ...
        databaseReferenceData.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    firebaseUpdate = newUpdateChild.get("college_football");


                }


                userUpdate = prefs.getLong("COLLEGEFOOTBALL_LASTUPDATE", 0);
                ...
                if (firebaseUpdate > userUpdate) {
                    ...
                    databaseReferenceItems.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast toast = Toast.makeText(getBaseContext(), "college football links updated", Toast.LENGTH_LONG);
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                for (int w = 0; w < names.size(); w++) {
                    ...
                    if (names.get(w).equals(selection)) {
                        ...
                        intent.putExtra("whichactivity", "collegefootball");
        ...
        listen_for_enter.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View view, int keyCode, KeyEvent event) {
                ...
                if ((event.getAction() == KeyEvent.ACTION_DOWN)
                    ...
                    String searchToPass = "http://www.sports-reference.com/cfb/search/search.fcgi?hint=" + searchfinal + "&search=" + searchfinal + "&pid=";

                    // http://www.pro-collegefootball-reference.com/search/search.fcgi?hint=tom+Ackerman&search=tom&pid=
