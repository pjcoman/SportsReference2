 ...
 */
public class NFLsearch extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String jsonFootballLinks = null;
        try {
            jsonFootballLinks = converJsonToStringFromAssetFolder(getApplicationContext());
        ...
        try {
            array = new JSONArray(jsonFootballLinks);
    ...
    private static String converJsonToStringFromAssetFolder(Context context) throws IOException {
        ...
        InputStream file = manager.open("football_links.json");
