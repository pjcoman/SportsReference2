...
public class CFBsearch extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String jsonCollegeFootballLinks = null;
        try {
            jsonCollegeFootballLinks = converJsonToStringFromAssetFolder(getApplicationContext());
        ...
        try {
            array = new JSONArray(jsonCollegeFootballLinks);
